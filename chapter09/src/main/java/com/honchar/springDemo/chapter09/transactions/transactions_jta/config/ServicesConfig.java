package com.honchar.springDemo.chapter09.transactions.transactions_jta.config;
...
@ComponentScan(basePackages = "com.honchar.springDemo.chapter09.transactions.transactions_jta.services")
public class ServicesConfig {

	private final Logger logger = LoggerFactory.getLogger(ServicesConfig.class);
