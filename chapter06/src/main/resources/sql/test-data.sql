...
insert into musicdb.singer (first_name, last_name, birth_date) values ('Jimi', 'Hendrix', '1942-11-27');

insert into musicdb.album (singer_id, title, release_date) values (1, 'The Search For Everything', '2017-01-20');
insert into musicdb.album (singer_id, title, release_date) values (1, 'Paradise Valley', '2013-08-19');
insert into musicdb.album (singer_id, title, release_date) values (1, 'Born and Raised', '2012-05-22');
