CREATE DATABASE IF NOT EXISTS MUSICDB8;

CREATE TABLE MUSICDB8.SINGER (
...
CREATE TABLE MUSICDB8.INSTRUMENT (
                            INSTRUMENT_ID VARCHAR(20) NOT NULL
    , PRIMARY KEY (INSTRUMENT_ID)
);

CREATE TABLE MUSICDB8.SINGER_INSTRUMENT (
                                   SINGER_ID INT NOT NULL
    , INSTRUMENT_ID VARCHAR(20) NOT NULL
